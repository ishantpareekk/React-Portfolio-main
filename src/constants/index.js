...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "Discover Exercise Lab, the premier React Fitness App featuring over a thousand exercises, detailed info, and YouTube integration. Browse categories, view examples, and find related videos effortlessly by Ishant Pareek!",
  ...
  },
  {
    ...
    image: project2,
    description:
      "Weather Flex app built with React.js, uses an API to fetch and display real-time weather data for any city. It provides a dynamic user interface to view current weather conditions, including temperature, humidity, and visibility by Ishant Pareek.",
    technologies: ["HTML", "CSS", "React Js", "API"],
    link: "https://weather-flex-ishant.netlify.app/",
  },
  {
    title: "To Do App",
    image: project3,
    description:
      "The to-do app, built with React, ensures tasks persist across browser refreshes using local storage. Users can add, check off completed tasks, and track their progress seamlessly by Ishant Pareek.",
    technologies: ["HTML", "CSS", "React"],
    link: "https://todo-app-by-ishant.netlify.app/",
  },
  // {
...
export const CONTACT = {
  address: "Churu, Rajasthan, IN ",
  phoneNo: "+91 7652918910",
  email: "ishantpareekk@gmail.com",
};
